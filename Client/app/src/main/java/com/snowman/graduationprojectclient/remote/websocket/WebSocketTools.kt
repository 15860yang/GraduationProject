...
import com.snowman.graduationprojectclient.remote.websocket.MyWebSocket.WebSocketReCreate
    ...
    private val heartBeatRunnable: Runnable = object : Runnable {
        override fun run() {
            if (mMyWebSocket != null) {
                ...
                mMyWebSocket = c!!.initWebSocket(UserManager.instance.nowDisplayDeviceId.value!!)
            }
            //定时对长连接进行心跳检测
